...
public class NightTrainStrategyTest {

  private NightTrainStrategy nightTrainStrategy;
  ...
  public void setUp() {
    ...
    nightTrainStrategy = new NightTrainStrategy();
  }
   ...
   * If it does, second train should be ElectricTrain, since the sequence is reset.
   */
  @Test
   ...
   * If it does, third train should be DieselTrain, since the sequence is decremented.
   */
  @Test
  public void testDecrementCount() {
    ...
    nightTrainStrategy.decrementCount();
    Train thirdTrain = nightTrainStrategy.createTrain(
        1, new Line(10002, "testLine", "TRAIN", testRouteOut, testRouteIn), 1.0);
    assertTrue(thirdTrain instanceof DieselTrain);
  }
}